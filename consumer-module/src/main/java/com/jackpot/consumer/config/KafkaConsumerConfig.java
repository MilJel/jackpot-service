package com.jackpot.consumer.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, BetMessage> consumerFactory() {
        JsonDeserializer<BetMessage> deserializer = new JsonDeserializer<>(BetMessage.class);
